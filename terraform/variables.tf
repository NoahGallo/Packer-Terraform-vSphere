...
#  type        = string
#  description = "ESXi host on which the VM gets deployed, as I don't have a cluster in my vCenter"
#}
...
variable "win-vm-guest-id" {
  type        = string
  description = "The ID of virtual machines operating system"
}

variable "win-vm-template-name" {
  type        = string
  description = "The template to clone to create the VM"
}